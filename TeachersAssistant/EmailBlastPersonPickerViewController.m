//
//  EmailBlastPersonPickerViewController.m
//  TeachersAssistant
//
...
@interface EmailBlastPersonPickerViewController ()
...
@implementation EmailBlastPersonPickerViewController
...
- (void)emailButtonPressed:(UIBarButtonItem *)button
{
	...
	{
		[recipients addObjectsFromArray:[person emailBlastEmailAddresses]];
	}
	
	MFMailComposeViewController *mailComposer = [[MFMailComposeViewController alloc] init];
	[mailComposer setMailComposeDelegate:self];
	
	NSString *toAddress = [[NSUserDefaults standardUserDefaults] btiEmailBlastToAddress];
	if (toAddress != nil)
	{
		[mailComposer setToRecipients:[NSArray arrayWithObject:toAddress]];
	}
	
	[mailComposer setBccRecipients:recipients];
