//
//  ReportClassPickerViewController.m
//  TeachersAssistant
//
...
@interface ReportClassPickerViewController ()
...
@implementation ReportClassPickerViewController
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	ReportPersonPickerViewController *nextViewController = [[ReportPersonPickerViewController alloc] init];
	[nextViewController setReportMode:[self reportMode]];
	[nextViewController setGradingPeriod:[self gradingPeriod]];
