//
//  CSVClassPickerViewController.m
//  TeachersAssistant
//
...
@interface CSVClassPickerViewController ()
...
@implementation CSVClassPickerViewController
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	CSVPersonPickerViewController *nextViewController = [[CSVPersonPickerViewController alloc] init];
	[nextViewController setExportMode:[self exportMode]];
