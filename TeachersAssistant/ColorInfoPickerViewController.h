//
//  ColorInfoPickerViewController.h
//  TeachersAssistant
//
...
@interface ColorInfoPickerViewController : BTIViewController <UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate>
{
}
